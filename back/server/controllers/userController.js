...
module.exports.createUser = async (req, res) => {
  ...
  console.log("****bienvenue dans le createUser")
...
module.exports.loginUser = async (req, res) => {
 ...
 console.log("****bienvenue dans le loginUser")    
...
module.exports.getUserProfile = async (req, res) => {
  ...
  console.log("****bienvenue dans le getUserProfile de userController.js")
...
module.exports.updateUserProfile = async (req, res) => {
  ...
  console.log("****bienvenue dans le updateUserProfile")
